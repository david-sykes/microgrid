...
l1 = Load('N_domestic', consumptions=[10, 40, 40], bus=b1)
...
Nsu1 = StorageUnit('N_battery', bus=b1, max_soc_capacity=100, max_charge_capacities=[10, 10, 10], max_discharge_capacities=[10, 10, 10],
        min_soc_requirements_start_of_ts=[20, 20, 20], consumptions=[0, 0, 0])

# Setup 2nd bus
b2 = Bus('South', network=n)
l2 = Load('S_domestic', consumptions=[100, 50, 100], bus=b2)
